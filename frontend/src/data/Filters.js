...
import priorityOptionsData, { priorityOptionsDataList } from "./priorityOptionsData"
...
export default function Filters({ onSubmit }) {
    ...
    const handleSubmit = (values) => {
        console.log('ofosuidofiuoiddddddddddddd')
        onSubmit(values);
    };
    ...
    console.log('resourceList desde filters xd:' ,resourceList)
